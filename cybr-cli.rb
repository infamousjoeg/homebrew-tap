class CybrCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/infamousjoeg/cybr-cli/releases/download/v1.0.0-release/cybr-cli_darwin_arm64.tar.gz"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/infamousjoeg/cybr-cli/releases/download/v1.0.0-release/cybr-cli_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/infamousjoeg/cybr-cli/releases/download/v1.0.0-release/cybr-cli_linux_arm64.tar.gz"
    ...
    if Hardware:CPU.intel?
      url "https://github.com/infamousjoeg/cybr-cli/releases/download/v1.0.0-release/cybr-cli_linux_amd64.tar.gz"
